...
function Content() {
    ...
    useEffect( () => {
        axios.get('https://www.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=24&regionCode=RS&key=AIzaSyBruxyIXl5dYfYl43sIFGQYMa2gJAUtHbQ')
